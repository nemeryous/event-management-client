...
const Footer = () => {
  return (
    <footer class="bg-[linear-gradient(135deg,#1e88e5_0%,#0d47a1_10 bg-secondary relative overflow-hidden py-5 pt-10 text-white">
      <div className="absolute top-0 right-0 left-0 h-1 bg-[linear-gradient(90deg,#fbc02d,#e53935,#43a047,#1e88e5)]"></div>
      <div class="mx-auto max-w-6xl px-5">
        <div class="mb-7 grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-7 lg:grid-cols-4 lg:gap-10">
          ...
          <div class="text-center md:text-start">
            ...
            <ul class="list-none">
              <li className="mb-3 flex items-center gap-2 text-sm text-blue-200">
                <div class="bg-accent flex size-5 shrink-0 items-center justify-center rounded-full text-xs">
        ...
        <div class="boder flex flex-col flex-wrap items-center justify-between gap-4 border-t pt-5 text-center lg:flex-row">
          <p className="text-sm text-blue-200">
            &copy; 2024 Trường Đại học Công nghệ Thông tin và Truyền thông Việt
            - Hàn. Tất cả quyền được bảo lưu.
          </p>
          <div class="flex justify-center gap-5 text-wrap">
            <a
              href="#"
