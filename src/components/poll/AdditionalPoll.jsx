  ...
  return (
    <div className="animate-fadeInUP rounded-2xl bg-white p-[25px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition duration-300 ease-in-out hover:-translate-y-[5px] hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
      <div className="mb-5 flex items-center justify-between">
        ...
        <button onClick={() => openPopup(true)} className="cursor-pointer rounded-lg border-none bg-[#1e88e5] px-5 py-2.5 text-[0.9rem] font-medium text-white transition-all duration-300 ease-in-out hover:translate-y-[-2px] hover:bg-[#1565c0]">
          Chọn câu hỏi
        </button>
      </div>
