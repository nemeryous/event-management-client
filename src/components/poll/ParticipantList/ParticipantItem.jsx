...
const ParticipantItem = ({avatar, name, email, votes}) => {
  return (
    <div className="mb-2 flex items-center gap-[15px] rounded-lg p-3 transition-colors duration-200 ease-in-out hover:bg-gray-100 hover:translate-x-[5px]">
      ...
      <div className="flex-1">
        <div className="text-[0.9rem] font-semibold text-[#333]">
          {name}
        </div>
