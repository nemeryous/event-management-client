  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex justify-end md:hidden">
      <div className="bg-white w-64 h-full shadow-lg p-6 flex flex-col gap-4 animate-slideInRight">
        <button
          onClick={onClose}
          className="self-end text-2xl text-[#c52032] font-bold mb-4"
        >
    ...
    >
      <div className="max-w-[1200px] mx-auto flex items-center justify-between px-4">
        ...
        <div className="flex items-center">
          <NavLink to="/admin/dashboard" className="flex items-center transition-transform hover:scale-105">
            <img
        ...
        <button
          className="md:hidden flex flex-col justify-center items-center w-10 h-10 mobile-menu-container"
