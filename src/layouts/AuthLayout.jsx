        ...
        <div className="flex min-h-screen bg-white">
          <div className="relative hidden overflow-hidden bg-[#F7F9FB] p-8 lg:flex lg:w-1/2">
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-20 left-10 h-32 w-32 rounded-full bg-[#FBC02D]"></div>
              <div className="absolute right-16 bottom-32 h-24 w-24 rounded-full bg-[#FBC02D]"></div>
              <div className="absolute top-1/2 left-1/4 h-16 w-16 rounded-full bg-[#FBC02D]"></div>
            </div>
            <div className="relative z-10 flex w-full flex-col items-start justify-center text-white">
              ...
              <div className="max-w-lg">
                <h1 className="mb-6 text-3xl leading-tight font-bold">
                  ...
                  <p className="text-[#E53935]">VKU Event Portal</p>
                </h1>
